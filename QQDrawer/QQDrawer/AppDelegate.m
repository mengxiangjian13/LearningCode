...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DrawerViewController *vc = (DrawerViewController *)self.window.rootViewController;
    
    CenterViewController *centerVC = [[CenterViewController alloc] init];
    UINavigationController *navi = [[UINavigationController alloc] initWithRootViewController:centerVC];
    
    vc.centerViewController = navi;
    
    LeftViewController *leftVC = [LeftViewController new];
    vc.leftViewController = leftVC;
    
    vc.backgroundImage = [UIImage imageNamed:@"sky.jpg"];
