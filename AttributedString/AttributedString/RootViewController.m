...
- (void)viewDidLoad
{
    ...
    [self setText:@"我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的我们都没看的地方的可积分打开可怜的快乐到家看得见绿壳蛋鸡考虑到减肥绿壳蛋鸡可怜的"];
